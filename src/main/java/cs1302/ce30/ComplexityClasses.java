...
public class ComplexityClasses extends Application {
    ...
    public void start(Stage stage) {
        ...
        LineChart<Number, Number> lc = ChartUtility.createChart(x, y, "Size",
                                                                "Operations", Y_BOUND, "nlogn");
        ...
        // Add the css styling to remove line symbols
        scene.getStylesheets().add("chartStyle.css");
                               
        stage.setTitle("Complexity Classes");
